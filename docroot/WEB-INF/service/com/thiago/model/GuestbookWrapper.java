...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
	...
	*/
	...
	@Override
	public int compareTo(com.thiago.model.Guestbook guestbook) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.thiago.model.Guestbook> toCacheModel() {
		return _guestbook.toCacheModel();
	}

	@Override
	public com.thiago.model.Guestbook toEscapedModel() {
		return new GuestbookWrapper(_guestbook.toEscapedModel());
	}

	@Override
	public com.thiago.model.Guestbook toUnescapedModel() {
