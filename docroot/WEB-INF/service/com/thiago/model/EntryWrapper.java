...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	@Override
	public com.thiago.service.persistence.EntryPK getPrimaryKey() {
	...
	*/
	@Override
	public void setPrimaryKey(com.thiago.service.persistence.EntryPK primaryKey) {
	...
	*/
	...
	@Override
	public int compareTo(com.thiago.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.thiago.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.thiago.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.thiago.model.Entry toUnescapedModel() {
